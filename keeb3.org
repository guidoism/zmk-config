...
&kp LSHFT   &kp Z    &kp X    &kp C    &kp V    &kp B        &kp N    &kp M    &kp COMMA    &kp DOT    &kp SLASH    &kp SEMI   
          ...
          &kp RALT  &kp LCMD  &mo 1   &mo 3       &kp LSHFT   &kp SPACE   &mo 2   &mo 8              
>;
};
...
2_layer {
 bindings = <
  &kp GRAVE    &none    &none    &none    &none    &none        &none    &multiplication_sign    &division_sign    &none    &none    &kp BSPC  
...
3_layer {
 ...
 &none    &none    &none    &none    &none    &none        &none   &kp HOME   &none   &kp END   &none    &none   
                     &none    &none        &none    &none                       
          &kp RALT  &kp LCMD  &mo 1    &trans       &kp LG(X)  &kp LG(C)  &kp LA(LS(LG(P)))   &none              
>;
};
