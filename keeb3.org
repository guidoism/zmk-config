...
#keymap -c keymap_drawer.config.yaml parse -c 12 -z config/andean-condor.keymap > /tmp/foo.yaml
#keymap -c keymap_drawer.config.yaml draw --qmk-info-json=flat-layout.json /tmp/foo.yaml > /tmp/foo.svg 
