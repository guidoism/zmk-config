...
// TAB = C + V
ZMK_COMBO(tab, &kp TAB, 27 28, ALL, 50)

// RET = M + ,
ZMK_COMBO(ret, &kp RET, 31 32, ALL, 50)

// BS = U + I
ZMK_COMBO(bksp, &kp BSPC, 7 8, ALL, 50)
...
<pre style="font-family: 'MonaspiceAr Nerd Font Mono'; font-weight: normal; font-style: normal;">
